        ...
        <div class="relative z-10 p-10 md:p-16 flex flex-col md:flex-row md:items-center justify-between gap-10">
            <div class="space-y-6">
                <div class="flex items-center gap-4">
                    <div class="inline-flex items-center px-4 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-blue-400">
                        <span class="w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse"></span>
                        Sistem Terkoneksi
                    </div>
                    
                    {{-- WIDGET PILIH BULAN (TIDAK MENCOLOK) --}}
                    <form method="GET" action="{{ route('dashboard') }}" class="relative group/select">
                        <select name="bulan" onchange="this.form.submit()" 
                            class="appearance-none pl-4 pr-10 py-1.5 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-400 focus:border-blue-500 outline-none transition-all cursor-pointer hover:bg-white/10">
